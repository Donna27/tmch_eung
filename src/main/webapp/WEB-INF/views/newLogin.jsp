	...
	<body>
	    ...
	    <div class="container marketing">
	      	<div class="featurette_ch">
		        <img class="featurette-image pull-right" src="<%=request.getContextPath()%>/resources/img/tmch.png">
	      	...
	      	<div class="featurette">
		        <img class="featurette-image pull-left" src="<%=request.getContextPath()%>/resources/img/doctor.png">
	      	...
	      	<hr class="featurette-divider">
	      	<div class="featurette">
	        	<img class="featurette-image pull-right" src="<%=request.getContextPath()%>/resources/img/mother.png">
