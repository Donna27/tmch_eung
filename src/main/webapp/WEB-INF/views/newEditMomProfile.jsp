      					...
      					<form class="form-horizontal span5" action="registerMemb" method="post">
        					...
        					<fieldset>					          	                						
					          	...
					          	<div class="control-group">
					            	...
					            	<div class="controls">
					              		<input id="fname" type="text" class="input-block-level" name="firstName">
					            	</div>
					          	</div>
					          	...
					          	<div class="control-group">
					            	...
					            	<div class="controls">
				                  		<input id="lname" type="text" class="input-block-level" name="lastName">
					            	</div>	
					          	</div>
					          	...
					          	<div class="control-group">
					            	<div class="controls">
					              		<button id="registbtn" type="submit" class="btn btn-primary">บันทึก</button>
					            	</div>
					          	</div>          
       						</fieldset>
      					</form>
